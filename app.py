...
def generate_email_html(full_name, recipient_email=None, subject=None, custom_html=None):
    ...
    # Tracking elements
    event_url = "https://www.eventbrite.co.uk/e/the-power-business-awards-isle-of-man-tickets-1673803815269?aff=emailcampaigns"
                            ...
                            <tr>
                              <td bgcolor="#D7262F" style="border-radius: 6px; text-align: center;">
                                <a href="{tracking_link}" target="_blank"
                                  ...
                                  🎟️ Register Your Interest to Nominate for an Award
                                </a>
                              </td>
                            </tr>
                          </table>
...
def send_email(sender_email, sender_password, row, subject, custom_html):
    try:
        server = smtplib.SMTP("mail.thepowerbusinessawards.com", 587)
        server.starttls()
        ...
        try:
            imap = imaplib.IMAP4_SSL("mail.thepowerbusinessawards.com")
...
sender_email = st.text_input("Sender Email", value="mark@thepowerbusinessawards.com")
